SCRIPTS = {'WOce_cm': {'START:0': [['#', 'to', 'is', '_left,', 'from', 'is', '_right'],
 ...
 'demon': {'BYE:0': [['goodbye']],
           ...
           'HIT': [['if', 'player', 'in', 'self.name'],
                   ['set', 'self', 'state', 'SPLODE'],
                   ['endif']],
           'SHIT:29': [['set', 'self', 'hits', 'self.hits', '-', '1'],
                       ['set', 'self', 'state', 'WAIT'],
                       ['set', 'self', 'frame', '0'],
                       ['if', 'self.hits', '<', '0'],
                       ['sfx', 'demon_death'],
 ...
 'eyeballattack': {'EYE:0': [['img', 'eyen'],
                   ...
                   'splode': [['sfx', 'eye_splat'],
                              ...
                              ['add', 'self.blood_n.imgs', 'blood3'],
                              ['endfor']]},
 'eyeballtarget': {'SHIT:20': [['if', 'witch0.state', '!=', 'RAGE'],
                               ['break'],
                               ['endif'],
                               ['sfx', 'witch_hit'],
                               ['set', 'witch0', 'state', 'SHIT'],
                   ...
                   'splode': [['set', 'self', 'goo0', 'self.name', '+', 'goo'],
                              ...
                              ['add', 'self.blood_n.imgs', 'blood3'],
                              ['endfor']]},
 'fighttrigger': {'COLLIDE': [['if', 'self.gun'],
                              ['set',
                               'fighttriggerdoor0',
                               'target',
                               'self.name'],
 ...
 'flyingspike': {'FLY:0': [['set', 'self', 'y_vel', 'self.speed']],
                 'FLY:280': [['set', 'self', 'x', 'self.orig_x'],
                 ...
                 'OFF:0': [['if', 'not', 'COLLIDE?'],
                           ['set', 'self', 'state', 'SPIKE'],
                           ['set', 'self', 'frame', '0'],
                           ['endif']],
                 'SPIKE:0': [['set', 'self', 'calc1', '0'],
                             ['set', 'self', 'calc2', '0'],
                             ['set', 'self', 'calc3', '0'],
                             ['if', 'exists', 'player10'],
                             ['set',
 ...
 'platformground': {'START:0': [['set', 'self', 'noWO', '1'],
                                ['set', 'self', 'state', 'PLATFORM'],
                                ['set', 'self', 'platform', '1']]},
 'player1': {'START:0': [['set', 'self', 'calc', 'isframe', 'MAIN'],
                         ['if', 'self.calc'],
                         ['set', 'self', '_input_name', 'PLAYER1'],
                         ['focus', 'MAIN', 'self'],
 ...
 'player2': {'BEGIN:0': [['if', 'isframe', 'MAIN2'],
             ...
             'START:0': [['set', 'self', 'state', 'BEGIN'],
                         ['set', 'self', 'frame', '0']]},
 'playsong_levelone': {'COLLIDE': [['if', 'self.gun'],
                                   ['set',
                                    'song_manager0',
                                    'song',
                                    'firstLevel'],
                       ...
                       'START:0': [['set', 'self', 'state', 'WAIT'],
                                   ['set', 'self', 'noWO', '1']]},
 'playsong_leveltwo': {'COLLIDE': [['if', 'self.gun'],
                                   ['set',
                                    'song_manager0',
                                    'song',
                                    'secondlevel'],
